...
%plotting the sines
t1=0:1:1450;
plot(haday,data(1:144,5)+data(1:144,4)*60,data(1:144,7),t1,2*sin(0.0083*t1));
t2=0:1:10000;
plot(haweek,data(1:1008,5)+data(1:1008,4)*60+(data(1:1008,1)-1)*1440,data(1:1008,7),t2,2*sin(0.0083*t2));
t3=0:1:90000;
plot(hafull,data(1:8784,5)+data(1:8784,4)*60+(data(1:8784,1)-1)*1440+(data(1:8784,2)-10)*44640,data(1:8784,7),t3,2*sin(0.0083*t3));
